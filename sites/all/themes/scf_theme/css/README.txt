...
To use these stylesheets, rename the files and scf_theme with the name of your theme.
...
scf_theme-alpha-default-narrow.css  
...
scf_theme-alpha-default-normal.css
...
scf_theme-alpha-default-wide.css
